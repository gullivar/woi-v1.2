...
const translations: Record<Language, Record<string, string>> = {
    ko: {
        ...
        'vdi.form.pc_select': 'Profile Selection',
        ...
        'vdi.form.name_id': 'Smart Group *',
        'vdi.form.add': '+ 추가',
        'vdi.form.apply_same_period': '동일기간 적용',
        'vdi.form.no': '번호',
        'vdi.form.user_name': '사용자 이름',
        'vdi.form.dept_name': '부서명',
        'vdi.form.workspace': 'Profile',
        'vdi.form.pc_type': 'Smart Group',
        ...
        'mock.default_title': 'James Wilson//R&D Part',
        'mock.default_reason': 'Applying for Profile for testing purposes.',
        'mock.dept_auto': '부서 자동입력',
        'mock.user_suffix': '.user',
        'mock.approver_suffix': '.approver',
        'mock.support_dept': '지원 파트',
        'vdi.form.WIN_P1': 'Windows Profile [Profile-01]',
        'vdi.form.MAC_P2': 'macOS Profile [Profile-02]',
        'vdi.form.IOS_P3': 'iOS Profile [Profile-03]',
        'vdi.form.AND_P4': 'Android Profile [Profile-04]',
    },
    en: {
        // Layout
